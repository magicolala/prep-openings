  ...
  return (
    <section className="prep-sheet" aria-label="Plan d'attaque personnalisé">
      <header className="prep-sheet__header">
        ...
        <p>
          Chaque carte résume une opportunité : gap de performance, coups recommandés, parties modèles. Visualisation abstraite pour un onboarding rapide.
        </p>
      </header>
            ...
            <article key={leak.id} className="leak-card" data-color={leak.color}>
              ...
              <div className="leak-card__insights">
                ...
                <div>
                  ...
                  {popularity !== null && <span className="insight-caption">Popularité explorer {formatPercent(popularity)}</span>}
                </div>
                <div>
              ...
              <div className="leak-card__actions">
                <div className="leak-card__chips">
                  {punishments.length ? (
                    ...
                    <span className="response-chip response-chip--empty">Pas de réf claire</span>
                  )}
                </div>
